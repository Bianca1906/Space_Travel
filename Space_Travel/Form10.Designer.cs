...
namespace Space_Travel
{
    partial class Pluto
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label2.Text = "Planeta Pluto";
            // 
            // menuStrip1
            // 
            ...
            "🚀Descoperită în 1930 de Clyde Tombaugh, numită după zeul roman al lumii subpămân" +
                "tene.",
            "",
            "🚀Pluto este o planetă pitică cu un diametru de aproximativ 2.377 km.",
            "",
            "🚀Orbita excentrică și înclinată face ca Pluto să se apropie mai mult de Soare de" +
                "cât Neptun",
            " în unele perioade.",
            "",
            "🚀 Atmosfera sa subțire, compusă în principal din azot și urme de metan și monoxi" +
                "d de carbon,",
            " suferă sublimare și condensare în funcție de poziția față de Soare.",
            "",
            "🚀Pluto are cinci luni cunoscute: Charon, Styx, Nix, Kerberos și Hydra. Charon fo" +
                "rmează un sistem binar cu Pluto."});
            this.listBox1.Location = new System.Drawing.Point(10, 266);
            ...
            this.imageList1.Images.SetKeyName(0, "pluto1.jpg");
            this.imageList1.Images.SetKeyName(1, "pluto2.jpg");
            this.imageList1.Images.SetKeyName(2, "pluto3.png");
            // 
            // Pluto
            // 
