...
namespace Space_Travel
{
    partial class Terra
    {
        ...
        private void InitializeComponent()
        {
            ...
            "🚀Un an pe Pământ nu are exact 365 de zile. Sunt de fapt 365,2564 zile.",
            " Aceste ,2525 de zile suplimentare creează necesitatea unui An bisec o dată la pa" +
                "tru ani.",
            " De aceea adăugăm o zi suplimentară în Februarie la fiecare patru ani – 2004, 200" +
                "8, 2012 etc.",
            "",
            "🚀Cel mai lung lanț muntos din lume este de fapt subacvatic.",
            "",
            "🚀Pământul a fost mov. Potrivit acestui articol din Live Science, microbii antici" +
                " ar fi putut",
            "folosi o altă moleculă decât clorofila pentru a valorifica razele soarelui, una c" +
                "are le conferea",
            "organismelor o nuanță violetă.",
            "",
            "🚀Pământul se reciclează. Știați că Pământul este singura planetă din sistemul no" +
                "stru solar",
            "care are plăci tectonice? Crusta exterioară a Pământului are mai multe regiuni nu" +
                "mite ",
            "plăci tectonice. Sub acestea se află un interior de magmă care determină mișcarea" +
                " plăcilor, ",
            "ciocnindu-se uneori una pe alta. Pe măsură ce se ciocnesc și se despart, ",
            "magma creează crusta proaspătă."});
            this.listBox1.Location = new System.Drawing.Point(10, 247);
            this.listBox1.Name = "listBox1";
            this.listBox1.Size = new System.Drawing.Size(960, 364);
            ...
            this.label2.Text = "Planeta Terra";
            // 
            // menuStrip1
            // 
            ...
            this.Name = "Terra";
            this.Text = "Terra";
            this.Load += new System.EventHandler(this.Terra_Load);
